...
window.onload = function() {
	document.getElementById("bottom-positioner").onclick = randomClick();
...
function randomClick() {
	...
	alert(a2);
 	switch(parseInt(a2.shift())) {
 		case 1:Ahandler(); break;
		case 2:Bhandler(); break;
		case 3:Chandler(); break;
		case 4:Dhandler(); break;
		case 5:Ehandler(); break;
 	}
