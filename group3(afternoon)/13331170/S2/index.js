...
function disableBitButtonNotChangeRingList(ringListState) {
...
function ringListClickByRobot(ringList, ringListState, ringListNum) {
	var ringListSelected = ringList[ringListNum];
	...
	_ajax.done(function(random_num) {
    	...
    	} else disableBitButtonNotChangeRingList(ringListState);
	});
