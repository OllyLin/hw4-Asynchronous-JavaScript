...
//onclick按钮触发事件
  document.getElementById("mask").onclick = function() {getRadomNumber(1,"mask");}
  document.getElementById("history").onclick = function() {getRadomNumber(2,"history");}
  document.getElementById("message").onclick = function() {getRadomNumber(3,"message");}
  document.getElementById("setting").onclick = function() {getRadomNumber(4,"setting");}
  document.getElementById("sign").onclick = function() {getRadomNumber(5,"sign");}
//onclick计算
  document.getElementById("page").onclick = calculate;
//鼠标移开以后复原
