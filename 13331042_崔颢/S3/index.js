...
var sendAjax = function(count, allLi, listState) {
	...
	if (listState[allLi[count].innerHTML[0]] == 0) {
		...
		XMLHttpReq.open("get", '/'+Math.random(), true);
...
// 判断是否所有都点击过一遍
var judgeFinish = function(allLi, listState) {
	judgeFinish.times++;
	var flag = 0;
...
window.onload = function() {
	...
	icon.onclick = function() {
		if (hasClass(this, "clicked")) {
			...
			for (var i = 0; i < 5; i++) listState = sendAjax(i, circles, listState);
		}
	}
}
