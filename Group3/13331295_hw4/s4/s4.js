                    ...
                    request.onreadystatechange = function() {
                        if (request.readyState === 4 && request.status === 200) {
                            ...
                            if (isAllGetNum()) {
                                ...
                                buttons_[click_order.shift()].click();
                            }
                        }
                    }
...
function ran_array(num) {
    var ran_array=[];
    for (var i = 0; i < num; i++) {
        ran_array[i] = i;
    }
    ran_array.sort(function(){return Math.random()>0.5?-1:1;})
    return ran_array;
}
