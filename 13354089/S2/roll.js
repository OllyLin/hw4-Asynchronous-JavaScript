...
function Robort(){//自动执行程序
  ...
  setTimeout(function(){getRadomNumber(2,"history");},3500);

  setTimeout(function(){ getRadomNumber(3,"message");},7000);
 
  setTimeout(function(){ getRadomNumber(4,"setting");},10500);
  
  setTimeout(function(){getRadomNumber(5,"sign");},14000);
